...
class ArmController(Node):
        ...
        while True:
            try:
                ...
                for device in devices:
                    print("Arm USB Info: ")
                    self.get_logger().info(device.description())
                ...
                self.get_logger().info(f'Failed to connect to arm: {e}')
    ...
    def activate_recycle(self):
        # default position
            ...
            # grab motion
            self.move_to(id=5, pos=1300, time=1000)
            self.move_to(id=3, pos=1200, time=1000)
            self.move_to(id=4, pos=-400, time=1000)
            time.sleep(1)
            self.move_to(id=1, pos=500, time=1000)
            time.sleep(1)
            self.move_to(id=1, pos=1100, time=1000)
            time.sleep(2)
            ...
            # drop motion
            self.move_to(id=3, pos=1000, time=1000)
